...
class DeveloperAppsApi:
    ...
    def get_developer_app(
        self,
        address: Annotated[StrictStr, Field(description="A developer app address (API Key)")],
        ...
        :param address: A developer app address (API Key) (required)
        :type address: str
    ...
    def get_developer_app_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeveloperAppResponse]:
        """get_developer_app
    ...
    def _get_developer_app_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/developer_apps/{address}',
