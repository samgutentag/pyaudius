...
class CollectionActivity(Activity):
    ...
    def item_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['playlist']):
            raise ValueError("must be one of enum values ('playlist')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "item": Playlist.from_dict(obj["item"]) if obj.get("item") is not None else None,
            "class": obj.get("class")
        })
        return _obj
