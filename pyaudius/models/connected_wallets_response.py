...
class ConnectedWalletsResponse(BaseModel):
    """
    ConnectedWalletsResponse
    """ # noqa: E501
    data: Optional[ConnectedWallets] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ConnectedWallets.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
