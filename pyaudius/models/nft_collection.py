...
class NftCollection(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["chain", "standard", "address", "name", "imageUrl", "externalLink"]
    ...
    def standard_validate_enum(cls, value):
        ...
        if value not in set(['ERC721', 'ERC1155']):
            raise ValueError("must be one of enum values ('ERC721', 'ERC1155')")
        return value
