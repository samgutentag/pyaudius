...
class RemixParent(BaseModel):
    """
    RemixParent
    """ # noqa: E501
    tracks: Optional[List[TrackElement]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tracks": [TrackElement.from_dict(_item) for _item in obj["tracks"]] if obj.get("tracks") is not None else None
        })
        return _obj
