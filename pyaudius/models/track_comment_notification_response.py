...
class TrackCommentNotificationResponse(BaseModel):
    """
    TrackCommentNotificationResponse
    """ # noqa: E501
    data: Optional[CommentNotificationSetting] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CommentNotificationSetting.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
