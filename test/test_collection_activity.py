...
class TestCollectionActivity(unittest.TestCase):
    """CollectionActivity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionActivity:
        """Test CollectionActivity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionActivity`
        """
        ...
        if include_optional:
            return CollectionActivity(
                timestamp = '',
                item_type = 'playlist',
                item = pyaudius.models.playlist.playlist(
    ...
    def testCollectionActivity(self):
        """Test CollectionActivity"""
