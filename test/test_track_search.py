...
class TestTrackSearch(unittest.TestCase):
    """TrackSearch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrackSearch:
        """Test TrackSearch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrackSearch`
        """
        model = TrackSearch()
        if include_optional:
            return TrackSearch(
