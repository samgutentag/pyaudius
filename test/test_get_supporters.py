...
class TestGetSupporters(unittest.TestCase):
    """GetSupporters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSupporters:
        """Test GetSupporters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSupporters`
        """
        model = GetSupporters()
        if include_optional:
            return GetSupporters(
                data = [
                    pyaudius.models.supporter.supporter(
                        rank = 56, 
                        amount = '', 
