...
class TestPlaylistTracksResponse(unittest.TestCase):
    """PlaylistTracksResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlaylistTracksResponse:
        """Test PlaylistTracksResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlaylistTracksResponse`
        """
    ...
    def testPlaylistTracksResponse(self):
        """Test PlaylistTracksResponse"""
