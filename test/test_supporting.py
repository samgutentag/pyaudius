...
class TestSupporting(unittest.TestCase):
    """Supporting unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Supporting:
        """Test Supporting
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Supporting`
        """
        model = Supporting()
        if include_optional:
            return Supporting(
