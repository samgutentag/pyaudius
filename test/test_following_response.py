...
class TestFollowingResponse(unittest.TestCase):
    """FollowingResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FollowingResponse:
        """Test FollowingResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FollowingResponse`
        """
        model = FollowingResponse()
        if include_optional:
    ...
    def testFollowingResponse(self):
        """Test FollowingResponse"""
