...
class TestSubscribersResponse(unittest.TestCase):
    """SubscribersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscribersResponse:
        """Test SubscribersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscribersResponse`
        """
        model = SubscribersResponse()
        if include_optional:
    ...
    def testSubscribersResponse(self):
        """Test SubscribersResponse"""
