...
class TestTrackActivity(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TrackActivity:
        """Test TrackActivity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrackActivity`
        """
        model = TrackActivity()
        if include_optional:
            return TrackActivity(
                item_type = 'track',
                item = pyaudius.models.track.Track(
