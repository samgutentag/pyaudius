...
class TestRelatedArtistResponse(unittest.TestCase):
    """RelatedArtistResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelatedArtistResponse:
        """Test RelatedArtistResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelatedArtistResponse`
        """
        model = RelatedArtistResponse()
        if include_optional:
    ...
    def testRelatedArtistResponse(self):
        """Test RelatedArtistResponse"""
