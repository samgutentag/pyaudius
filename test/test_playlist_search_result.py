...
class TestPlaylistSearchResult(unittest.TestCase):
    """PlaylistSearchResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlaylistSearchResult:
        """Test PlaylistSearchResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlaylistSearchResult`
        """
        model = PlaylistSearchResult()
        if include_optional:
    ...
    def testPlaylistSearchResult(self):
        """Test PlaylistSearchResult"""
