...
class TestPlaylistsResponse(unittest.TestCase):
    """PlaylistsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlaylistsResponse:
        """Test PlaylistsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlaylistsResponse`
        """
    ...
    def testPlaylistsResponse(self):
        """Test PlaylistsResponse"""
