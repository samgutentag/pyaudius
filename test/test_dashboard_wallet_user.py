...
class TestDashboardWalletUser(unittest.TestCase):
    """DashboardWalletUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DashboardWalletUser:
        """Test DashboardWalletUser
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashboardWalletUser`
        """
        model = DashboardWalletUser()
        if include_optional:
            return DashboardWalletUser(
                wallet = '',
    ...
    def testDashboardWalletUser(self):
        """Test DashboardWalletUser"""
