...
class TestFollowersResponse(unittest.TestCase):
    """FollowersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FollowersResponse:
        """Test FollowersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FollowersResponse`
        """
        model = FollowersResponse()
        if include_optional:
    ...
    def testFollowersResponse(self):
        """Test FollowersResponse"""
